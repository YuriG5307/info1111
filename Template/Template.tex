...
\textbf{Github link: https://github.com/YuriG5307/info1111.git}\\[2cm]

{\large
\begin{tabular}{|p{0.35\textwidth}|p{0.55\textwidth}|}
	\hline
	{\bf Student name} & Yiyang Gao\\
	{\bf Student ID} & 510015154\\
	{\bf Topic} & C \textit{Note: This must be the same as was in your topic approval}\\
	{\bf Levels already achieved} & Level A, B, C\\
	{\bf Levels in this report} & Level A, B, C\\
	\hline
\end{tabular}
}
\thispagestyle{empty}
